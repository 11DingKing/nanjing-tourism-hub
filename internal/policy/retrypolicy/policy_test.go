...
func validInput() Input {
	...
	return Input{ActorRole: "system", ActorRegion: "", ObjectRegion: "", CurrentState: "pending", TargetState: "running", Capacity: 100, Committed: 20, Requested: 10, ExpectedVersion: 4, ActualVersion: 4, DependencyCount: 0, Now: now, Deadline: now.Add(time.Hour)}
}
