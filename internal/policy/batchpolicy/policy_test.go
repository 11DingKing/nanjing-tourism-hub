...
func validInput() Input {
	...
	return Input{ActorRole: "duty_officer", ActorRegion: "", ObjectRegion: "", CurrentState: "queued", TargetState: "processing", Capacity: 100, Committed: 20, Requested: 10, ExpectedVersion: 4, ActualVersion: 4, DependencyCount: 0, Now: now, Deadline: now.Add(time.Hour)}
}
